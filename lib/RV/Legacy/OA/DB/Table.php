...
class Table
{
    ...
    public function createTable($table, $oDate = null, $suppressTempTableError = false)
    {
        ...
        $tableName = $this->_generateTableName($table);
        ...
        if (isset($this->aDefinition['tables'][$table]['indexes']) && is_array($this->aDefinition['tables'][$table]['indexes'])) {
