...
/**
 * The Advertiser class extends the OA_Dll class.
 *
 */

class Advertiser extends \OA_Dll
{
    /**
     ...
     * @access private
     *
     * @param AdvertiserInfo &$oAdvertiser
     ...
     * @access private
     *
     * @param AdvertiserInfo &$oAdvertiser  Structure with advertiser information.
     *
     ...
     * @access public
     *
     * @param AdvertiserInfo &$oAdvertiser <br />
     *          <b>For adding</b><br />
    ...
    public function getAdvertiser($advertiserId, &$oAdvertiser)
    {
        if ($this->checkIdExistence('clients', $advertiserId)) {
            ...
            $oAdvertiser = new AdvertiserInfo();
