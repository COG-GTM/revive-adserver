...
/**
 * The Channel class extends the OA_Dll class.
 *
 */

class Channel extends \OA_Dll
{
    /**
    ...
    public function getChannelTargeting($channelId, &$aTargetingList)
    {
        if ($this->checkIdExistence('channel', $channelId)) {
            ...
            while ($doChannelTargeting->fetch()) {
                ...
                $oChannelTargeting = new TargetingInfo();
     ...
     * @access public
     *
     * @param TargetingInfo $oTargeting
     *
     * @return boolean
     */
