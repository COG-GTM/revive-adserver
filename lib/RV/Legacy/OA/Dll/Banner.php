...
/**
 * The Banner class extends the OA_Dll class.
 *
 */

class Banner extends \OA_Dll
{
    /**
     ...
     * @access private
     *
     * @param BannerInfo &$oBanner  Banner object.
     *
    ...
    public function getBannerTargeting($bannerId, &$aBannerList)
    {
        if ($this->checkIdExistence('banners', $bannerId)) {
            ...
            while ($doBannerTargeting->fetch()) {
                ...
                $oBannerTargeting = new TargetingInfo();
